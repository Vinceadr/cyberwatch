"""FlowLayout — Layout responsive qui arrange les widgets en grille fluide."""
...
class FlowContainer(QWidget):
    """Widget wrapper that correctly propagates heightForWidth from FlowLayout."""

    def __init__(self, h_spacing: int = 16, v_spacing: int = 16, parent: QWidget | None = None) -> None:
        super().__init__(parent)
